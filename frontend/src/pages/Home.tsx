...
export const Home: React.FC = () => {
  ...
  return (
    <div className="relative w-full">
      {/* Hero Section */}
      <section className="relative min-h-screen w-full overflow-hidden flex items-center gradient-bg border-b border-gray-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-28 pb-16 flex items-center">
      ...
      {/* Page Content wrapped in page layout constraints */}
